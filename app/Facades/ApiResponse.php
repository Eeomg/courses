 ...
 * @method static ApiResponseLogic unauthrized($message = 'unauthorized process',$code = Response::HTTP_UNAUTHORIZED)
 * @method static ApiResponseLogic faild($errors,$message,$code)
